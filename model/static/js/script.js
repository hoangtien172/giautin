...
async function scan(e) {
  ...
  // const socket = io.connect("http://0.0.0.0:555"); // Đảm bảo địa chỉ và cổng này khớp với cài đặt của ứng dụng Flask
  ...
  // socket.on("predection", function (data) {
  //   console.log("Received prediction data from the server: ", data);
  // });
